define({ "api": [
  ...
  {
    "type": "post",
    "url": "survey/add/answers/",
    "title": "Добавить ответ",
    "parameter": {
      "examples": [
        {
          "title": "Example-Request:",
          "content": "[\n    {\n        \"id\": 7, \"survey_answers\": [5]\n    }, \n    {   \n        \"id\": 11, \"survey_answers\": [16, 17, 18, 19]\n    }\n]",
          "type": "json"
        }
      ],
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>ID ответов через запятую</p>"
          }
        ]
      }
    },
        ...
        "Response": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Опрос пройден удачно</p>"
          }
        ]
      }
    },
    "error": {
      "examples": [
        {
          "title": "Error-Response:",
          "content": "{\n    \"error_message\": \"Количество ответов должно быть 7\"\n}",
          "type": "json"
        }
      ]
    },
    ...
    "group": "Опросы",
    "description": "<p>Необходимо оправить список ID вопросов, со списком ID ответов</p>",
      ...
      "fields": {
        "Response": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "index",
            "description": "<p>Порядковый номер вопроса</p>"
          },
          {
            "group": "Response",
            "type": "Boolean",
      ...
      "fields": {
        "Response": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "morning_time",
            "description": "<p><code>Утро</code> время суток</p>"
          },
          {
            "group": "Response",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "evening_time",
            "description": "<p><code>Вечер</code> время суток</p>"
          },
          {
            "group": "Response",
            "type": "String",
            "optional": false,
            "field": "day_end_time",
            "description": "<p><code>Конец дня</code></p>"
          },
          {
            "group": "Response",
            "type": "Float",
          ...
          },
          {
            ...
            "optional": false,
            "field": "is_survey",
            "description": "<p>Опрос пройден <code>True</code> - да, <code>False</code> - нет</p>"
          },
          {
            "group": "Response",
            "type": "String",
            "optional": false,
            "field": "photo",
            "description": "<p>Ссылка на фото профиля</p>"
          }
        ]
      }
    },
